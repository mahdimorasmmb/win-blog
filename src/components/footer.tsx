/**
 * v0 by Vercel.
 * @see https://v0.dev/t/EIY5JqlH4XF
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between border-b border-gray-300 pb-8">
            <div className="mb-6 md:mb-0">
              <a href="#" className="text-2xl font-bold text-[#bd1e59]">
                Sahand\'s Blog
              </a>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mt-8">
            <p className="text-gray-600 text-sm text-center md:text-left mb-4 md:mb-0">&copy; 2024 Sahand\'s blog</p>
